...
target_list['email_clean'] = target_list['User Email'].str.strip().str.lower()
...
final_report.to_csv('2023_Student_Demographics.csv', index=False, encoding='utf-8-sig')

print("Success! '2023_Student_Demographics.csv' has been created.")
